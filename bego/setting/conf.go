...
func LoadConfig() *goconfig.ConfigFile {
	...
	beego.BConfig.WebConfig.Session.SessionName = Cfg.MustValue("session", "session_name", "shentong_sess")
	...
	dataSource := Cfg.MustValue("orm", "data_source", "webgame:123456@tcp(182.92.149.107:3306)/webgame?charset=utf8&loc=UTC")
...
func reloadConfig() {
	AppName = Cfg.MustValue("app", "app_name", "bego")
	...
	CookieRememberName = Cfg.MustValue("app", "cookie_remember_name", "shentong_magic")
	CookieUserName = Cfg.MustValue("app", "cookie_user_name", "shentong_powerful")
	...
	//MailUser = Cfg.MustValue("mailer", "mail_name", "ShenTong Community")
